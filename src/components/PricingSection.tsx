      ...
      <div className="container mx-auto px-8">
        ...
        <div className="max-w-7xl mx-auto">
              ...
              <div
                ...
                className={`group relative ${
                  plan.popular 
                    ...
                    : ''
                } bg-white rounded-2xl border border-gray-200 hover:border-gray-300 hover:shadow-2xl transition-all duration-500 hover:-translate-y-1`}
              >
                {/* Popular Badge */}
                {plan.popular && (
                ...
                {/* Gradient background */}
                <div className={`absolute inset-0 bg-gradient-to-br ${plan.gradient} opacity-0 group-hover:opacity-100 rounded-2xl transition-opacity duration-500`}></div>
          ...
          <div className="text-center mt-20">
            <div className="max-w-4xl mx-auto bg-gray-50 rounded-2xl border border-gray-200 p-8">
