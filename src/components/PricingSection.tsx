                ...
                <div key={item.company} className="w-full flex-shrink-0 px-8 md:px-16 py-14 flex flex-col gap-8">
                  <div className="flex flex-col md:flex-row md:items-center gap-10">
                    <div className="flex items-center justify-center">
                      <div className="w-44 h-30 rounded-3xl bg-white shadow-[0_18px_40px_rgba(15,23,42,0.12)] border border-slate-200 flex items-center justify-center overflow-hidden">
                        <img src={item.logo} alt={`${item.company} logo`} className="max-w-[150px] max-h-[100px] object-contain" />
                      </div>
                    </div>
