      ...
      <nav className="container mx-auto px-8 py-6">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center space-x-6">
            ...
            <button className="px-6 py-2.5 bg-gray-900 text-white hover:bg-gray-800 transition-all duration-300 font-medium text-sm rounded-lg shadow-sm hover:shadow-md">
              {t('nav.panel')}
            </button>
          </div>
          ...
          <div className="lg:hidden mt-6 py-6 bg-white/95 backdrop-blur-xl border border-gray-100 rounded-2xl shadow-xl">
            <div className="flex flex-col space-y-6 px-6">
              ...
              <div className="flex flex-col space-y-3 pt-6 border-t border-gray-200">
                ...
                <button className="px-6 py-2.5 bg-gray-900 text-white hover:bg-gray-800 transition-colors font-medium rounded-lg">
                  {t('nav.panel')}
                </button>
              </div>
            </div>
